...
export const tr = {
  ...
  games: {
    ...
    voiceDescribe: 'Sıra sizde: kartı masanıza anlatın. Yasaklı kelimeleri söylemeyin.',
    voiceDescribeHint: 'Diğer masa kartı görüyor ve Doğru, Tabu ya da Pas diyor.',
    ...
    legacyGame:
      'Bu oyun uygulamanın eski bir sürümüyle başladı. Bitince oda sahibi yeni oyunu buradan başlatabilir.',
  },
  reveal: {
